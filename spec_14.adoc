...
+
Existing Equivalent:: `srun -n 10 --mem-per-cpu=2048 app` or
...
'''
Use Case 11:: Request resources across multiple clusters
+
Specific Example::
...
'''
Use Case 12: Request N cores across M switches
+
Specific Example::
